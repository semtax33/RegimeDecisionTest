...
def solve_weights(
    ...
    detail: dict[str, Any] = {
        **values,
        "policy": "DailyTechnicalConfidence_StaticLambda",
...
def run_research(save: bool = True) -> dict[str, Any]:
    ...
    paths = {
        ...
        "Stage20_DailyTechnicalConfidence": technical_path,
    }
    ...
    episodes = pd.concat(
        [
            ...
            drawdown_episodes(
                technical_path, returns, "Stage20_DailyTechnicalConfidence"
            ),
        ],
        ignore_index=True,
    )
    ...
    candidate = full.loc["Stage20_DailyTechnicalConfidence"]
    ...
    report: dict[str, Any] = {
        "strategy": "Stage20_DailyTechnicalConfidence",
    ...
    if save:
        ...
        technical_path.to_csv(
            OUTPUT_DIR / "daily_technical_confidence_monthly.csv"
        )
