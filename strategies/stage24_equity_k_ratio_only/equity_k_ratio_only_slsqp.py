...
def solve_weights(
    ...
    detail: dict[str, Any] = {
        **values,
            "policy": "EquityKRatioOnly_StaticLambda",
...
def run_research(save: bool = True) -> dict[str, Any]:
    ...
    paths = {
        ...
        "Stage24_EquityKRatioOnly": technical_path,
    }
    ...
    episodes = pd.concat(
        [
            ...
            drawdown_episodes(
                technical_path, returns, "Stage24_EquityKRatioOnly"
            ),
        ],
        ignore_index=True,
    )
    ...
    candidate = full.loc["Stage24_EquityKRatioOnly"]
    ...
    report: dict[str, Any] = {
        "strategy": "Stage24_EquityKRatioOnly",
        ...
        "feature_policy": {
            ...
            "single_change_from_stage20": (
                "K-Ratio is the sole equity direction input"
            ),
            "research_status": (
                "exploratory follow-up declared after Stage 21-23 results"
            ),
        },
        "unchanged_controls": {
            "downside_risk_aversion_lambda": 1.0,
    ...
    if save:
        ...
        technical_path.to_csv(
            OUTPUT_DIR / "equity_k_ratio_only_monthly.csv"
        )
